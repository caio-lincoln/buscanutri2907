...
Este documento descreve o sistema completo de upload e edição de imagens implementado para perfis de usuários (nutricionistas, empresas e pacientes), incluindo funcionalidades de crop, redimensionamento e otimização.
