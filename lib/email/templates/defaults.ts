...
export const defaultSubjects: Record<UserRole, string> = {
  NUTRITIONIST: 'Bem-vindo(a) ao NutriBusca — Comece a atender hoje!',
  PATIENT: 'Bem-vindo(a) ao NutriBusca — Sua jornada de saúde começa aqui',
  COMPANY: 'Bem-vindo(a) ao NutriBusca — Conecte sua equipe à nutrição'
}
...
export const defaultTextTemplates: Record<UserRole, string> = {
  NUTRITIONIST: `Olá {{name}}! Complete seu perfil, conecte pagamentos e publique sua agenda no NutriBusca.`,
  PATIENT: `Olá {{name}}! Encontre nutricionistas e agende seu atendimento pelo NutriBusca.`,
