...
DROP TABLE IF EXISTS public.selection_processes CASCADE;
...
INSERT INTO public.company_stats (company_id, total_jobs, active_jobs, total_applications, hired_candidates, conversion_rate, avg_hiring_time, cost_per_hire, candidate_satisfaction)
SELECT 
  id,
  0,
  0,
