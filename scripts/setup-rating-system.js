...
async function applyRatingSystem() {
  ...
  try {
    ...
    console.log('  - Nutricionista tem rating:', nutritionistProfile?.rating !== undefined);
    console.log('  - Paciente tem rating:', patientProfile?.rating !== undefined);
    ...
    if (consultationsError) {
      ...
      console.log('📊 Encontradas', consultationsWithRatings?.length || 0, 'avaliações existentes');
    }
