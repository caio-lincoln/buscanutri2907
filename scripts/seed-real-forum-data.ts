...
async function seedRealForumData() {
  ...
  const questions = [
    {
      ...
      content: 'Gostaria de saber como posso calcular corretamente meu gasto calórico diário para ajustar minha dieta. Tenho 25 anos, peso 70kg e faço exercícios 3x por semana.',
    ...
    },
    {
      ...
      content: 'Moro em uma região com pouco sol e trabalho em escritório. Meu médico sugeriu suplementação de vitamina D. Gostaria da opinião de nutricionistas sobre isso.',
    ...
    },
    {
      ...
      content: 'Estou tentando melhorar minha alimentação e ouvi falar que a quinoa é mais nutritiva que o arroz branco. É uma boa substituição? Como preparar?',
    ...
    },
    {
      ...
      content: 'Comecei na academia há 2 meses e quero ganhar massa muscular. Qual seria uma dieta adequada? Preciso de suplementos?',
      category: 'Nutrição Esportiva',
    ...
    },
    {
      ...
      content: 'Estou grávida de 3 meses e gostaria de orientações sobre alimentação. Quais alimentos devo evitar e quais são essenciais?',
  ...
  const answers = [
    {
      ...
      content: 'Para calcular seu gasto calórico diário, você pode usar a fórmula de Harris-Benedict. Para homens: TMB = 88,362 + (13,397 × peso) + (4,799 × altura) - (5,677 × idade). Depois multiplique pela atividade física (1,375 para exercícios 3x/semana).',
    ...
    },
    {
      ...
      question_id: '7d28cc92-0694-419d-b9e1-0c04e840515c',
      content: 'Complementando a resposta anterior, recomendo usar aplicativos como MyFitnessPal que fazem esse cálculo automaticamente. Também é importante ajustar conforme seus resultados.',
    ...
    },
    {
      ...
      content: 'A suplementação de vitamina D é realmente importante, especialmente em regiões com pouco sol. Recomendo fazer um exame de sangue primeiro para verificar seus níveis atuais. A dose usual é de 1000-2000 UI por dia.',
    ...
    },
    {
      ...
      content: 'A quinoa é excelente! Tem proteína completa, fibras e minerais. Para preparar: lave bem antes de cozinhar (1 xícara de quinoa para 2 de água), cozinhe por 15 minutos. Pode usar no lugar do arroz em qualquer receita.',
    ...
    },
    {
      ...
      content: 'Para ganho de massa muscular, foque em: 1,6-2,2g de proteína por kg de peso corporal, carboidratos complexos pré e pós-treino, gorduras boas. Whey protein pode ajudar, mas não é obrigatório se você conseguir proteína suficiente na dieta.',
    ...
    },
    {
      ...
      content: 'Durante a gravidez é essencial: ácido fólico, ferro, cálcio, ômega-3. Evite: álcool, peixes com mercúrio, carnes cruas, queijos não pasteurizados. Inclua: folhas verdes, frutas, proteínas magras, laticínios pasteurizados.',
  ...
  try {
    ...
    const bestAnswers = [
      { questionId: '7d28cc92-0694-419d-b9e1-0c04e840515c', answerId: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' },
      { questionId: 'ab53f2fc-e5a4-4817-9ba8-ad731242764a', answerId: 'c3d4e5f6-a7b8-9012-cdef-345678901234' },
      { questionId: '887e9f96-909a-4175-9024-c17034d07dd2', answerId: 'e4ed1468-1b84-4b88-a20f-a5b33f71561c' },
      { questionId: 'c4f8e2a1-9b3d-4e5f-8c7a-1d2e3f4a5b6c', answerId: '7ce2091b-732d-4cb2-a54a-b2e1fb29260a' },
      { questionId: 'f7e6d5c4-b3a2-9180-7f6e-5d4c3b2a1098', answerId: '05305749-674a-422d-a9ee-a96271a5ecdf' }
    ]
