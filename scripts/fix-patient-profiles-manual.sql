-- =====================================================
-- SCRIPT PARA CORRIGIR POLÍTICAS RLS - PATIENT_PROFILES
-- =====================================================
-- Execute este script no SQL Editor do Supabase Dashboard
-- URL: https://supabase.com/dashboard/project/lutokoucdfhfbwtppzwe/sql
...
-- Política adicional: Nutricionistas podem ver perfis de pacientes durante consultas ativas
...
-- 5. Criar view public.users para compatibilidade (se não existir)
