    ...
    const questions = [
      {
        ...
        content: 'Gostaria de saber qual é a melhor forma de calcular quantas calorias devo consumir por dia para manter meu peso atual. Tenho 25 anos, peso 65kg e pratico exercícios 3 vezes por semana.',
      ...
      },
      {
        ...
        content: 'Meu médico recomendou suplementação de vitamina D, mas gostaria de saber se posso obter essa vitamina apenas através da alimentação e exposição solar.',
      ...
      },
      {
        ...
        content: 'Sou vegetariana há 2 anos e comecei a treinar musculação. Quais são as melhores fontes de proteína vegetal para ganho de massa muscular?',
    ...
    const answers = [
      {
        ...
        content: 'Para calcular suas necessidades calóricas, você pode usar a fórmula de Harris-Benedict ou Mifflin-St Jeor. Com base nos seus dados (25 anos, 65kg, exercícios 3x/semana), sua necessidade seria aproximadamente 1800-2000 calorias por dia. Recomendo consultar um nutricionista para um cálculo mais preciso.',
        likes_count: 5,
        is_best_answer: true,
      ...
      },
      {
        ...
        content: 'Eu uso aplicativos como MyFitnessPal que fazem esse cálculo automaticamente. É bem prático!',
        likes_count: 2,
      ...
      },
      {
        ...
        nutritionist_id: 'ef005068-f71e-44f5-8f94-0d6c065e85be', // Heloisa Lima Bitencourt
        author_id: '296ed103-ef5a-4151-8745-7225a07afd1e',
        content: 'A vitamina D pode ser obtida através da exposição solar (15-20 minutos diários) e alimentos como peixes gordurosos, ovos e cogumelos. Porém, em muitos casos a suplementação é necessária, especialmente no inverno. Siga a orientação do seu médico.',
        likes_count: 3,
        is_best_answer: false,
      ...
      },
      {
        ...
        nutritionist_id: 'ef005068-f71e-44f5-8f94-0d6c065e85be', // Heloisa Lima Bitencourt
        author_id: '296ed103-ef5a-4151-8745-7225a07afd1e',
        content: 'Excelentes fontes de proteína vegetal incluem: leguminosas (feijão, lentilha, grão-de-bico), quinoa, tofu, tempeh, sementes de hemp, spirulina e proteína de ervilha. Combine diferentes fontes para obter todos os aminoácidos essenciais.',
        likes_count: 8,
        is_best_answer: true,
