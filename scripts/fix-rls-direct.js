...
async function fixRLSPolicies() {
  ...
  try {
    ...
    await client.query('ALTER TABLE public.patient_profiles ENABLE ROW LEVEL SECURITY;');
    ...
    try {
      await client.query('CREATE INDEX IF NOT EXISTS idx_patient_profiles_user_id ON public.patient_profiles(user_id);');
    ...
    try {
      ...
      await client.query('DROP TRIGGER IF EXISTS update_patient_profiles_updated_at ON public.patient_profiles;');
      await client.query(`
