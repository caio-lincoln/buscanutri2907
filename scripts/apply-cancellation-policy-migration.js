...
async function addCancellationPolicyColumn() {
  try {
    console.log('🚀 Adicionando coluna cancellation_policy à tabela nutritionist_profiles...')
    ...
    if (error) {
      if (error.message.includes('cancellation_policy')) {
        console.log('⚠️  A coluna ainda não foi adicionada. Tente executar o SQL manualmente no dashboard do Supabase.')
