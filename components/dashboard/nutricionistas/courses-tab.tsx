  ...
  const courses = [
    {
      ...
      description:
        'Aprofunde seus conhecimentos em patologias complexas e planos alimentares específicos.',
    ...
    },
    {
      ...
      description:
        'Aprenda a construir sua marca pessoal e atrair mais pacientes online.',
      image: '/placeholder.svg?height=200&width=300',
    ...
    },
    {
      ...
      description:
        'Domine estratégias nutricionais para atletas de diferentes modalidades.',
      image: '/placeholder.svg?height=200&width=300',
    ...
    },
    {
      ...
      description:
        'Explore ferramentas de IA para otimizar diagnósticos e planos alimentares.',
      image: '/placeholder.svg?height=200&width=300',
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Amplie suas qualificações e mantenha-se atualizado com as últimas
            tendências.
          </p>
        </div>
