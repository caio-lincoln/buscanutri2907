        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="border-0 shadow-md bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-semibold text-[#1E1D40] flex items-center gap-2">
                  <LineChart className="h-5 w-5 text-gray-600" /> Tráfego do
                  Site
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-md bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-semibold text-[#1E1D40] flex items-center gap-2">
                  <BarChart className="h-5 w-5 text-gray-600" /> Cadastros por
                  Tipo de Usuário
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-md bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-semibold text-[#1E1D40] flex items-center gap-2">
                  <PieChart className="h-5 w-5 text-gray-600" /> Origem do
                  Tráfego
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-md bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-semibold text-[#1E1D40] flex items-center gap-2">
                  <Globe className="h-5 w-5 text-gray-600" /> Usuários por
                  Localização
                </CardTitle>
              </CardHeader>
              <CardContent>
