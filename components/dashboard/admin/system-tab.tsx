...
export function SystemTab() {
  ...
  const handleRestartService = (serviceName: string) => {
    alert(`Serviço ${serviceName} reiniciado com sucesso!`)
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <Badge
                        variant="outline"
                        className={`capitalize ${serviceStatusColors[service.status]}`}
                      >
                        {service.status}
                      </Badge>
                    </div>
        ...
        <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-semibold text-[#1E1D40] flex items-center gap-2">
              <HardDrive className="h-5 w-5 text-gray-600" /> Gerenciamento de
              Cache
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-gray-600">
              Limpe o cache da aplicação para garantir que os usuários vejam as
        ...
        <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-semibold text-[#1E1D40] flex items-center gap-2">
              <AlertTriangle className="h-5 w-5 text-gray-600" /> Modo de
              Manutenção
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
