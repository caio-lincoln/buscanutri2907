...
import { getPatientChatConversations, type ChatConversation } from "@/lib/chat-forum-service"
    ...
    <div className="space-y-8">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Converse com seus nutricionistas e acompanhe suas conversas</p>
        </div>
      </div>
          ...
          {recentConversations.length > 0 ? (
            recentConversations.map((conversation) => (
              <div
                ...
                onClick={() => router.push(`/dashboard/paciente/chat/${conversation.id}`)}
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-[#1E1D40]">
                      {conversation.nutritionist_profiles?.full_name || "Nutricionista Desconhecido"}
                    </p>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">Suas conversas com nutricionistas aparecerão aqui.</p>
