                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isActive ? config.iconBg : "bg-gray-100 group-hover:bg-gray-200 group-hover:shadow-md",
                        )}
                      >
                        <Icon
                          className={cn(
                      ...
                      <span className={cn("flex-1 font-medium text-sm", isActive && "text-current")}>{item.label}</span>
                      {item.badge && (
                        <Badge
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-sm font-semibold text-[#1E1D40] truncate max-w-[120px]">{userName}</span>
                    <span className={cn("text-xs font-medium capitalize", config.textColor)}>{userType}</span>
                  </div>
                </div>
