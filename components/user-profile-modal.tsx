...
export function UserProfileModal({
  ...
  // Função para carregar horários de disponibilidade do nutricionista
  const loadNutritionistAvailability = async () => {
    if (userType !== 'nutricionista') return
    ...
    try {
      ...
      console.error('Erro ao carregar horários de disponibilidade:', error)
    }
  }
  ...
  const loadAnamneseData = async () => {
    try {
      ...
      // Silent operation - no anamnese found, creating new
  ...
  const handleCPFChange = (value: string) => {
    ...
    if (!validateCPFFormat(formatted)) {
      setCpfValidation({
        status: 'invalid',
        message: 'Formato de CPF invalido',
      })
      return
    }
  ...
  const handleAlturaAnamneseChange = (
    ...
    if (currentPage === 3 && userType === 'paciente') {
      if (!validatePage3()) {
        toast({
          ...
          description:
            'Por favor, preencha todos os campos obrigatórios da anamnese nutricional.',
          variant: 'destructive',
        })
        return
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType === 'nutricionista') {
        ...
        if (typeof dataToSubmit.certifications === 'string') {
          dataToSubmit.certifications = processStringField(
            dataToSubmit.certifications,
            'certifications'
          )
        }
        if (typeof dataToSubmit.achievements === 'string') {
          dataToSubmit.achievements = processStringField(
            dataToSubmit.achievements,
            'achievements'
          )
        }
      }
      ...
      if (userType === 'nutricionista' && selectedSpecialties.length > 0) {
        try {
          ...
          // Silent error handling - specialty save error
          toast({
            title: 'Aviso',
            description:
              'Perfil salvo, mas houve um erro ao salvar as especialidades.',
            variant: 'destructive',
          })
        }
      }
      ...
      if (userType === 'paciente' && anamneseData) {
        try {
          ...
          // Silent error handling - anamnese save error
          ...
          <div className="space-y-4 mb-6">
            <div className="flex flex-col items-center gap-4">
              <Avatar className="h-24 w-24">
                <AvatarImage
                  ...
                  alt={
                    userType === 'empresa'
                      ? formData?.company_name || 'Profile Image'
                      : formData?.full_name || 'Profile Image'
                  }
                  key={
                    userType === 'empresa'
                      ? formData?.logo_url
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-xs text-gray-500 mt-1">
                {userType === 'empresa'
                  ? 'Cole a URL do logo da sua empresa.'
          ...
          {userType === 'nutricionista' && (
            <div className="space-y-4 mb-6 border-t pt-6">
              ...
              <div className="max-w-md mx-auto">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Cole a URL da imagem de capa do seu perfil. Esta imagem
                  aparecerá no topo da sua página pública.
                </p>
              </div>
            </div>
          )}
              ...
              {currentPage === 1 && (
                <>
                  <div className="text-center text-gray-600">
                    <p>
                      Complete as próximas páginas com suas informações
                      nutricionais.
                    </p>
                  </div>
                </>
                ...
                <>
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">
                      Anamnese Nutricional - Informações Básicas
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={e =>
                            handleAnamneseChange('genero', e.target.value)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            handleAnamneseChange('email', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            handleAnamneseChange('instagram', e.target.value)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            handleAnamneseChange('cidade', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            handleAnamneseChange('estado', e.target.value)
                          }
              ...
              {currentPage === 3 && (
                <>
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="anamnese_historico_peso">
                        Histórico de Peso
                      </Label>
                      <Textarea
                        ...
                        onChange={e =>
                          handleAnamneseChange('historico_peso', e.target.value)
                        }
                    ...
                    <div>
                      <Label htmlFor="anamnese_medicacoes">
                        Medicações em Uso
                      </Label>
                      <Textarea
            ...
            <>
                ...
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        checked={
                          formData?.online_consultation_available || false
                        }
                        onChange={handleChange}
                        className="rounded border-gray-300"
                      />
                      <Label
                        htmlFor="online_consultation_available"
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label
                        htmlFor="online_only_consultation"
                        className="text-sm font-normal"
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        id="aceita_cupons"
                        checked={formData?.aceita_cupons || false}
                        onChange={handleChange}
                        className="rounded border-gray-300"
                      />
                      <Label
                        ...
                        className="text-sm font-normal"
                      >
                        Aceito participar de campanhas de cupons de desconto
                      </Label>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Selecione até 5 especialidades que melhor descrevem sua
                      área de atuação
                    </p>
                  </div>

                  <div>
                    <Label htmlFor="consultation_languages">
              ...
              {userType === 'nutricionista' && currentPage === 2 && (
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="default_consultation_duration">
                    ...
                    <div>
                      <Label htmlFor="min_time_between_appointments">
