  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (type === "question") {
        ...
        success = await updateForumAnswer(
          itemId,
          content.trim(),
          userId
        )
      ...
      if (success) {
        ...
        alert("Erro ao atualizar. Verifique se você tem permissão para editar este item.")
      }
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="content" className="text-sm font-medium text-gray-700">
              {type === "question" ? "Descrição da Pergunta" : "Conteúdo da Resposta"} *
            </Label>
            <Textarea
              id="content"
              value={content}
