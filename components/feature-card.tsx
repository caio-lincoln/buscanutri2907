...
export function FeatureCard({
  ...
  return (
    <div
      className={cn("p-6 rounded-xl transition-all duration-300 animate-fade-in-up", getVariantStyles(), className)}
      style={{ animationDelay: `${index * 100}ms` }}
    >
      <div className={cn("w-12 h-12 rounded-lg flex items-center justify-center mb-4", getIconStyles(), iconClassName)}>
