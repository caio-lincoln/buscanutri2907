...
export function StatsCard({ title, value, icon: Icon, color, trend, description, className }: StatsCardProps) {
  // Garante fallback seguro caso a cor não exista no objeto.
  const config = colorConfig[color] ?? colorConfig.blue

  return (
    <Card className={cn("border-0 shadow-lg backdrop-blur-sm hover-lift transition-all duration-300", className)}>
