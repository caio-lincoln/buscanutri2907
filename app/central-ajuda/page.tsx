...
export default function CentralAjudaPage() {
  const categorias = [
    {
      ...
      description:
        'Como encontrar nutricionistas, agendar consultas e usar a plataforma',
      artigos: 12,
    },
    {
      icon: BookOpen,
      ...
      description:
        'Gerenciar perfil, atender pacientes e usar ferramentas profissionais',
      artigos: 18,
    },
    {
      icon: Shield,
      title: 'Para Empresas',
      description:
        'Publicar vagas, gerenciar candidatos e usar recursos corporativos',
      artigos: 8,
    },
  ]
  ...
  const perguntasFrequentes = [
    ...
    },
    {
      ...
      resposta:
        'Sim, o cadastro e busca são gratuitos. Alguns recursos premium podem ter custos adicionais.',
    },
    {
      pergunta: 'Como posso entrar em contato com o suporte?',
      resposta:
        'Você pode nos contatar pelo email buscanutri@gmail.com ou pelo telefone (79) 9 9813-4938.',
    },
  ]
              ...
              >
                ...
                <CardContent className="text-center">
                  <p className="text-sm text-gray-500 mb-4">
                    {categoria.artigos} artigos disponíveis
                  </p>
