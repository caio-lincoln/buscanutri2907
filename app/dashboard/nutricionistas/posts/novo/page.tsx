...
import { BlogPostsService, CreateBlogPostData } from '@/lib/blog-posts-service'
...
export default function NovoPostPage() {
  ...
  const [postData, setPostData] = useState<CreateBlogPostData>({
    title: '',
    content: '',
    excerpt: '',
    category: '',
  ...
  const handleSave = async (status: 'draft' | 'published' | 'scheduled') => {
    ...
    if (status === 'scheduled' && !postData.scheduled_for) {
    ...
    try {
      ...
      const { data, error } = await BlogPostsService.createPost(dataToSave)
      ...
      const statusText = status === 'draft' ? 'salvo como rascunho' : 
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Crie um novo artigo para compartilhar conhecimento
              </p>
            </div>
          </div>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  disabled={loading || !postData.scheduled_for}
                  variant="outline"
                  className="w-full"
                >
