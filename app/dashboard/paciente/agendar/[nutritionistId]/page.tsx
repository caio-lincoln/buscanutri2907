    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50/50 via-white to-white flex">
      ...
      <div className="flex-1 lg:ml-64">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#1E1D40]">Perfil do Nutricionista</h1>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1 justify-center">
                      {(typeof getSpecialtiesText() === "string" ? getSpecialtiesText().split(", ") : [getSpecialtiesText()])
                        .map((specialty, index) => (
                          <Badge
                            key={index}
                            variant="outline"
                  ...
                  <div className="pt-4 border-t">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <h3 className="text-lg font-semibold text-yellow-800 mb-2">Funcionalidade Temporariamente Indisponível</h3>
                      <p className="text-yellow-700">
                        O agendamento de consultas está temporariamente indisponível. 
                        Entre em contato diretamente com o nutricionista para agendar sua consulta.
                      </p>
                    </div>
                  </div>
                </div>
