...
export default function PatientDashboard() {
  ...
  const loadAvailableLocations = async () => {
    try {
      ...
      // Silent error handling for locations loading
    }
  }
  ...
  const handleRatingSubmit = async (rating: number, comment: string) => {
    ...
    try {
      ...
      if (error) {
        // Silent error handling for rating save
        return
      }
      ...
      if (user) {
        ...
        // Silent success handling for rating save
      }
    } catch (error) {
      // Silent error handling for rating submission
    }
  }
  ...
  const formatDate = (dateString: string | null | undefined) => {
    ...
    try {
      ...
      // Silent error handling for date formatting
