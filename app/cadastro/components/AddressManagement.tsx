...
export default function AddressManagement({ className, nutritionistId, onAddressesChange }: AddressManagementProps) {
  const { user } = useUser()
  ...
  const loadAddresses = async () => {
    ...
    try {
      setLoading(true)
      const addressesData = await nutritionistAddressService.getAddressesByNutritionist(currentNutritionistId)
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge variant={address.type === "in_person" ? "default" : "secondary"}>
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {address.service_radius_km && address.type === "in_person" && (
                        <p>Raio de atendimento: {address.service_radius_km} km</p>
                      )}
                    </div>
                  </div>
            ...
            <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData(prev => ({
                        ...prev,
                        service_radius_km: e.target.value ? parseInt(e.target.value) : undefined
                      }))
                    }
                    placeholder="30"
                  />
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? "Salvando..." : (editingIndex === -1 ? "Adicionar" : "Salvar")}
                </Button>
              </div>
            </CardContent>
          </Card>
