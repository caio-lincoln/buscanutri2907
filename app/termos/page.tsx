        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href="mailto:legal@buscanutri.com.br"
                      className="text-[#4AB0D9] hover:underline"
                    >
          ...
          <div className="space-y-8">
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Ao acessar e utilizar a plataforma Busca Nutri, você concorda
                  integralmente com estes Termos de Uso. Se você não concorda
                  com qualquer parte destes termos, não deve utilizar nossos
                  serviços.
                </p>
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Estes termos constituem um acordo legal entre você e a Busca
                  Nutri (CNPJ: 57.370.073/0001-92), estabelecendo as condições
                  para uso de nossa plataforma digital.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  A Busca Nutri é uma plataforma digital que conecta
                ...
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80">
                  ...
                  <li>
                    Sistema de busca e agendamento de consultas presenciais
                  </li>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80 mb-4">
                  ...
                  <li>
                    Para empresas: possuir CNPJ ativo e documentação válida
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80">
                  ...
                  <li>
                    Atualizar informações pessoais e profissionais regularmente
                  </li>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80 mb-4">
                  <li>
                    Utilizar a plataforma para fins profissionais legítimos
                  </li>
                  <li>
                    Compartilhar conteúdo educativo e científico relevante
                  </li>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Todo o conteúdo da plataforma Busca Nutri, incluindo mas não
                  limitado a textos, gráficos, logotipos, ícones, imagens,
                  clipes de áudio, downloads digitais e software, é propriedade
                  da Busca Nutri ou de seus fornecedores de conteúdo.
                </p>
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Os usuários mantêm os direitos sobre o conteúdo que criam e
                  publicam, mas concedem à Busca Nutri uma licença não exclusiva
                  para usar, modificar e distribuir esse conteúdo na plataforma.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  A coleta, uso e proteção de seus dados pessoais são regidos
                  por nossa
                  <Link
                    href="/privacidade"
                  ...
                  , que está em conformidade com a Lei Geral de Proteção de
                  Dados (LGPD).
                </p>
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Ao utilizar nossa plataforma, você consente com a coleta e uso
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  A Busca Nutri atua como intermediadora, não sendo responsável
                  por:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80">
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <h4 className="font-semibold text-[#1E1D40] mb-3">
                  8.1 Política de Pagamentos
                </h4>
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80 mb-4">
                  <li>
                    Pagamentos são processados através de parceiros seguros
                  </li>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  A Busca Nutri reserva-se o direito de suspender ou encerrar
                  contas que violem estes Termos de Uso, sem aviso prévio,
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  A Busca Nutri pode modificar estes Termos de Uso a qualquer
                  momento. As alterações entrarão em vigor imediatamente após
                  sua publicação na plataforma.
                </p>
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  É responsabilidade do usuário revisar periodicamente estes
                  termos. O uso continuado da plataforma após as modificações
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  ...
                  Qualquer disputa decorrente destes termos será resolvida no
                  foro da comarca de Aracaju, Estado de Sergipe, com exclusão de
            ...
            <Card className="border-[#4AB0D9]/20 shadow-lg bg-[#4AB0D9]/5">
              ...
              <CardContent>
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  Para dúvidas, sugestões ou questões relacionadas a estes
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-700 text-sm leading-relaxed">
                    Ao continuar usando a plataforma Busca Nutri, você confirma
                    que leu, compreendeu e concorda com todos os termos e
                    condições estabelecidos neste documento. Se você não
                    concorda com algum termo, deve interromper o uso da
