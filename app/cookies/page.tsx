        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      href="mailto:cookies@buscanutri.com.br"
                      className="text-[#4AB0D9] hover:underline"
                    >
          ...
          <div className="space-y-8">
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  ...
                  seu dispositivo (computador, tablet ou smartphone) quando você
                  visita um site. Eles são amplamente utilizados para fazer os
                  sites funcionarem de forma mais eficiente e fornecer
                  informações aos proprietários do site.
                </p>
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Na Busca Nutri, utilizamos cookies e tecnologias similares
                  para melhorar sua experiência, personalizar conteúdo e
                  analisar como nossa plataforma é utilizada.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-2">
                  <strong>Finalidade:</strong> Necessários para o funcionamento
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-2">
                  <strong>Finalidade:</strong> Coletar informações sobre como
                  você usa nossa plataforma
                </p>
                <ul className="list-disc pl-6 space-y-1 text-[#1E1D40]/80 mb-4">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-2">
                  <strong>Finalidade:</strong> Personalizar sua experiência na
                  plataforma
                </p>
                <ul className="list-disc pl-6 space-y-1 text-[#1E1D40]/80 mb-4">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-2">
                  <strong>Finalidade:</strong> Entregar publicidade relevante e
                  medir eficácia
                </p>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  Alguns cookies em nossa plataforma são definidos por serviços
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  ...
                  Utilizados para manter você logado durante a navegação.
                </p>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  ...
                  em nossa plataforma através do painel de configurações de
                  privacidade.
                </p>
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed mb-2">
                  Você também pode controlar cookies através das configurações
                  do seu navegador:
                </p>
                <ul className="list-disc pl-6 space-y-1 text-[#1E1D40]/80 mb-4">
                  <li>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4">
                  <p className="text-amber-800 text-sm">
                    <strong>Importante:</strong> Desabilitar cookies essenciais
                    pode afetar o funcionamento da plataforma e limitar algumas
                    funcionalidades.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  Em relação aos cookies e dados coletados, você tem o direito
                  de:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-[#1E1D40]/80">
                  <li>
                    <strong>Consentimento:</strong> Dar ou retirar consentimento
                    para cookies não essenciais
                  </li>
                  <li>
                    <strong>Acesso:</strong> Saber quais cookies estão sendo
                    utilizados
                  </li>
                  <li>
                    <strong>Exclusão:</strong> Solicitar a remoção de cookies e
                    dados associados
                  </li>
                  <li>
                    <strong>Portabilidade:</strong> Receber dados coletados via
                    cookies em formato estruturado
                  </li>
                  <li>
                    <strong>Oposição:</strong> Opor-se ao uso de cookies para
            ...
            <Card className="border-[#F2E6D8] shadow-lg">
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <p className="text-[#1E1D40]/80 leading-relaxed">
                  Recomendamos que você revise esta política regularmente. A
            ...
            <Card className="border-[#4AB0D9]/20 shadow-lg bg-[#4AB0D9]/5">
              ...
              <CardContent>
                <p className="text-[#1E1D40]/80 leading-relaxed mb-4">
                  Para dúvidas sobre cookies, exercer seus direitos ou obter
