...
const solutions = [
  {
    ...
    description: "Programas de nutrição personalizados para melhorar a saúde e produtividade dos colaboradores",
    features: ["Consultas individuais", "Palestras educativas", "Cardápios corporativos", "Acompanhamento contínuo"],
    color: "bg-blue-500",
  },
  {
    icon: Briefcase,
    title: "Recrutamento Especializado",
    description: "Encontre e contrate os melhores nutricionistas para sua equipe ou projetos específicos",
    features: ["Banco de talentos", "Processo seletivo", "Avaliação técnica", "Suporte na contratação"],
    color: "bg-green-500",
  },
  {
    icon: Shield,
    title: "Consultoria Nutricional",
    description: "Assessoria especializada para restaurantes, hospitais, escolas e indústria alimentícia",
    features: [
      "Análise nutricional",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/cadastro?tipo=empresa">
              <Button className="bg-[#1E1D40] hover:bg-[#1E1D40]/90 text-white">Cadastrar Empresa</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main>
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold text-[#1E1D40] leading-tight">
                    Transforme a <span className="text-[#4AB0D9]">saúde corporativa</span> da sua empresa
                  </h1>
                  <p className="text-xl text-[#1E1D40]/70 leading-relaxed">
                    Soluções completas em nutrição para empresas: programas de bem-estar, recrutamento de profissionais
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#1E1D40]">200+</div>
                    <div className="text-sm text-[#1E1D40]/60">Empresas Atendidas</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#1E1D40]">50k+</div>
                    <div className="text-sm text-[#1E1D40]/60">Colaboradores</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-[#1E1D40]/60">Redução Custos</div>
                  </div>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#1E1D40]/70 max-w-3xl mx-auto">
                Programas personalizados para atender as necessidades específicas da sua empresa
              </p>
            </div>

            <div className="grid lg:grid-cols-3 gap-8">
              {solutions.map((solution, index) => (
                <Card key={index} className="border-2 hover:border-[#4AB0D9] hover:shadow-lg transition-all">
                  <CardHeader>
                    <div className={`w-12 h-12 ${solution.color} rounded-xl flex items-center justify-center mb-4`}>
                      <solution.icon className="h-6 w-6 text-white" />
                    </div>
                    <CardTitle className="text-xl text-[#1E1D40]">{solution.title}</CardTitle>
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full mt-6 bg-[#1E1D40] hover:bg-[#1E1D40]/90">Saiba Mais</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        <section className="py-20 bg-slate-50/30">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E1D40] mb-6">Benefícios Comprovados</h2>
              <p className="text-lg text-[#1E1D40]/70">
                Investir na saúde dos colaboradores gera resultados mensuráveis para sua empresa
              </p>
            </div>
              ...
              {benefits.map((benefit, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-8">
                    ...
                    <div className="text-3xl font-bold text-[#4AB0D9] mb-2">{benefit.stat}</div>
                    <h3 className="font-semibold text-[#1E1D40] mb-2">{benefit.title}</h3>
                    <p className="text-sm text-[#1E1D40]/70">{benefit.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {plans.map((plan, index) => (
                <Card
                  key={index}
                  className={`relative ${
                    plan.popular ? "border-2 border-[#1E1D40] shadow-lg scale-105" : "border border-gray-200"
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <Badge className="bg-[#1E1D40] text-white px-4 py-1">Mais Escolhido</Badge>
                    </div>
                  )}
                  ...
                  <CardContent>
                    ...
                    >
                      {plan.price === "Sob consulta" ? "Falar com Consultor" : "Solicitar Proposta"}
                    </Button>
                  </CardContent>
                </Card>
              ))}
                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-[#1E1D40]">Nome do Responsável</label>
                        <Input placeholder="Seu nome completo" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-[#1E1D40]">E-mail Corporativo</label>
                        <Input type="email" placeholder="seu@empresa.com" />
                      </div>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-[#1E1D40]">Nome da Empresa</label>
                        <Input placeholder="Nome da sua empresa" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-[#1E1D40]">Número de Funcionários</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-[#1E1D40]">Interesse</label>
                      <select className="w-full h-10 px-3 border border-gray-300 rounded-md">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-[#1E1D40]">Mensagem</label>
                      <Textarea placeholder="Conte-nos mais sobre suas necessidades..." className="min-h-[120px]" />
                    </div>
                    <Button size="lg" className="w-full bg-[#1E1D40] hover:bg-[#1E1D40]/90">
                      Solicitar Proposta
                      <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                  </form>
          ...
          <div className="container px-4 md:px-6 text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold">
                Invista na <span className="text-blue-200">saúde</span> dos seus colaboradores
              </h2>
              <p className="text-xl text-white/90">
                Empresas que investem em bem-estar têm colaboradores mais produtivos, engajados e satisfeitos
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/cadastro?tipo=empresa">
                  <Button size="lg" variant="secondary" className="bg-white text-[#1E1D40] hover:bg-gray-100">
                    Começar Agora
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>
