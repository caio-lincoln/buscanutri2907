...
const benefits = [
  {
    ...
    description:
      'Todos os nutricionistas passam por rigoroso processo de verificação de credenciais e experiência.',
  },
  {
    icon: MapPin,
    title: 'Encontre Próximo a Você',
    description:
      'Localize nutricionistas na sua região ou opte por consultas online de qualquer lugar.',
  },
  {
    icon: Calendar,
    title: 'Agendamento Fácil',
    description:
      'Agende suas consultas online de forma rápida e prática, com confirmação automática.',
  },
  {
    icon: Shield,
    title: 'Segurança e Privacidade',
    description:
      'Seus dados pessoais e de saúde são protegidos com os mais altos padrões de segurança.',
  },
  {
    icon: Star,
    title: 'Avaliações Reais',
    description:
      'Veja avaliações e comentários de outros pacientes para escolher o melhor profissional.',
  },
  {
    icon: Heart,
    title: 'Cuidado Personalizado',
    description:
      'Receba atendimento personalizado focado nas suas necessidades e objetivos específicos.',
  },
]
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/cadastro?tipo=paciente">
              <Button className="bg-[#D90D32] hover:bg-[#D90D32]/90 text-white">
                Cadastrar
              </Button>
            </Link>
          </div>
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold text-[#1E1D40] leading-tight">
                    Encontre o{' '}
                    <span className="text-[#D90D32]">nutricionista ideal</span>{' '}
                    para transformar sua saúde
                  </h1>
                  <p className="text-xl text-[#1E1D40]/70 leading-relaxed">
                    Conecte-se com profissionais verificados, agende consultas
                    presenciais ou online e inicie sua jornada rumo a uma vida
                    mais saudável.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
                  <Link href="/nutricionistas">
                    <Button
                      size="lg"
                      className="bg-[#D90D32] hover:bg-[#D90D32]/90 text-white px-8 py-4 text-lg"
                    >
                      Ver Nutricionistas
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-[#1E1D40] mb-6">
                Por que escolher a{' '}
                <span className="text-[#D90D32]">Busca Nutri</span>?
              </h2>
              <p className="text-xl text-[#1E1D40]/70 max-w-3xl mx-auto">
                Oferecemos a melhor experiência para conectar você com
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => (
                <Card
                  key={index}
                  className="border border-red-100 hover:shadow-lg transition-shadow"
                >
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {consultationTypes.map((type, index) => (
                <Card
                  key={index}
                  className="border-2 hover:border-[#D90D32] hover:shadow-lg transition-all"
                >
          ...
          <div className="container px-4 md:px-6 text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold">
                ...
                <span className="text-pink-200">saúde</span>?
              </h2>
              <p className="text-xl text-white/90">
                Junte-se a milhares de pessoas que já encontraram o
                nutricionista ideal na Busca Nutri
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/nutricionistas">
                  <Button
                    size="lg"
                    variant="secondary"
                    className="bg-white text-[#D90D32] hover:bg-gray-100"
                  >
